    ...
    <div className="admin-dashboaed-container">
      ...
      <div className="admin-dashboaed-admin-dashboaed">
        <div className="admin-dashboaed-car-availablity">
          ...
          <div className="admin-dashboaed-input">
              ...
              <div className="admin-dashboaed-datetime">
                <div>
                  <div className="admin-dashboaed-input2">
                    ...
                    />
                    <div className="admin-dashboaed-frame2">
                      <span className="admin-dashboaed-text02 ParagraphBody">
            ...
            <div className="admin-dashboaed-frame40123">
              <span className="admin-dashboaed-text04">
                <span>Set</span>
              </span>
            </div>
          </div>
        </div>
        <div className="admin-dashboaed-car-availablity1">
          <div className="admin-dashboaed-header1">
            <span className="admin-dashboaed-text06 HeaderH4">
              <span>Flight Availablity</span>
            </span>
          </div>
          <div className="admin-dashboaed-input3">
            <div className="admin-dashboaed-frame401661">
              ...
              <div className="admin-dashboaed-datetime1">
                <div className="admin-dashboaed-frame211">
                  <div className="admin-dashboaed-input5">
                    <img
                      src="/playground_assets/calendarchecki936-a05k.svg"
                      alt="calendarcheckI936"
                      className="admin-dashboaed-calendarcheck1"
                    />
            ...
            <div className="admin-dashboaed-frame401231">
              <span className="admin-dashboaed-text10">
                <span>Set</span>
              </span>
            </div>
          </div>
        ...
        <div className="admin-dashboaed-mainmenu">
            ...
            <div className="admin-dashboaed-menuitem">
              <div className="admin-dashboaed-menutop">
                <div className="admin-dashboaed-menu1">
                  ...
                  />
                  <span className="admin-dashboaed-text12 ParagraphButtontext">
                    <span>Dashboard</span>
                  </span>
                  <img
                ...
                <div className="admin-dashboaed-menu2">
                  ...
                  />
                  <span className="admin-dashboaed-text14">
          ...
          <div className="admin-dashboaed-logout">
            <div className="admin-dashboaed-logout1">
              ...
              <span className="admin-dashboaed-text22 H4">
                <span>Logout</span>
              </span>
            </div>
          </div>
        ...
        <div className="admin-dashboaed-live-car-status">
          <div className="admin-dashboaed-header2">
